    ...
    <div className={cx("container")}>
      ...
      <div className={cx("rightBackground")}>
        ...
        <div className={cx("enterInfo")}>
          ...
          <input placeholder="lv.hoang610@gmail.com" value={username} onChange={(e) => setUsername(e.target.value)} />
          <img src={cricle} alt="Cricle" className={cx("iconEnd")} />
        </div>
        <div className={cx("enterInfo")}>
          <img src={icon_password} alt="Password" className={cx("iconStart")} />
          <input placeholder="lv.hoang0610" value={password} onChange={(e) => setPassword(e.target.value)} />
          <img src={eye} alt="Cricle" className={cx("iconEnd")} />
        </div>
        <div className={cx("btnLogin")} onClick={handleSubmit}>
        ...
        <div className={cx("rememberPassword")}>
          ...
          <Link to="/resetPassword" className={cx("textReset")}>
            Reset it now
          </Link>
        </div>
      </div>
